...
import { ALLOWED_IMAGE_TYPES, MAX_PLACE_PHOTOS, PHOTO_MAX_BYTES } from "@/lib/community/constants";
...
export async function POST(request: Request) {
  try {
    ...
    const photo = await addPlacePhoto(supabase, user.id, place, path, caption || undefined);
